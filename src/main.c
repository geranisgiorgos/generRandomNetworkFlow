...
void init(){
    w=(double *)malloc((NODES1)*sizeof(double));
    s=(double *)malloc((DENSITY1)*sizeof(double));
    t=(double *)malloc((DENSITY1)*sizeof(double));
    Checked=(int *)malloc((NODES1)*sizeof(int));

    X_flows=(long *)malloc((DENSITY1)*sizeof(long));
    D=(long *)malloc((DENSITY1)*sizeof(long));
    Y_flows=(long *)malloc((DENSITY1)*sizeof(long));

    Tree=(long *)malloc((NODES1)*sizeof(long));
    Orientation=(long *)malloc((NODES1)*sizeof(long));
    C_par=(long *)malloc((NODES1)*sizeof(long));

    X=(long *)malloc((NODES1)*sizeof(long));
    BasicTree0=(long *)malloc((NODES1-1)*sizeof(long));
    BasicTree1=(long *)malloc((NODES1-1)*sizeof(long));
